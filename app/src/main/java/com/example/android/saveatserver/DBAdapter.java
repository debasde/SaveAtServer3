...
public class DBAdapter extends SQLiteOpenHelper {
    ...
    private static final String DB_NAME ="DB_saveatserver";
     ...
     * @return DBAdapter
     */
    public static synchronized DBAdapter getDBAdapterInstance(View.OnClickListener context) {
        if (mDBConnection == null) {
            mDBConnection = new DBAdapter((Context) context);
        }
